...
def part1(numbers):
    ...
    print(f'Part 1: There are {increased} measurements that are larger than the previous measurements.')
    return()
...
def part2(numbers):
    ...
    increased = 0
    slide_index = 0
    prev_window = [numbers[slide_index], numbers[slide_index+1], numbers[slide_index+2]]
    slide_index += 1
    while (slide_index + 2) < len(numbers):
        cur_window = [numbers[slide_index], numbers[slide_index+1], numbers[slide_index+2]]
    ...
    print(f'Part 2: There are {increased} sliding measurements that are larger than the previous measurements.')
